...
pipeline{
    ...
    stages{
        ...
        stage('Docker Deploy'){
            steps{
              ansiblePlaybook credentialsId: 'vagrant', disableHostKeyChecking: true, extras: "-e DOCKER_TAG=${DOCKER_TAG}", installation: 'ansible', inventory: 'dev.inv', playbook: 'dev-deploy.yml'
            sh "echo hi "
